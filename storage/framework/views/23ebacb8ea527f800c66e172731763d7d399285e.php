          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <div class="table-responsive">
                        <form action="<?php echo e(URL::to('dashboard')); ?>/license-request" id="licenseRequest" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                        ...
                                        <!--        <div class="col-sm-10">-->
                                        <!--                <select class="form-control select-multiple" name="pid[]" id="inputPassword3"  style="min-height:100px;" multiple="multiple" size=<?php echo e(count($products)); ?>>-->
