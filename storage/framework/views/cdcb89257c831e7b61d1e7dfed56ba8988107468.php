                      ...
                      <div class="card mb-3">
                        ...
                        <div class="card-body">
                                <div class="table-responsive">
                                  <form id="licence-gen" action="<?php echo e(URL::to('dashboard/s/issue-license')); ?>" method="post" enctype="multipart/form-data">
                                          <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="form-group row">
                                                               <!--  <label for="inputPassword3" class="col-sm-2 col-form-label">Product</label>
                                                                <div class="col-sm-10">
                                                                        <select class="form-control select-multiple" name="pid[]" id="inputPassword3" style="min-height:100px;" multiple="multiple" size=<?php echo e(count($products)); ?> required>
                                                                                <option value="0" >Select...</option> -->
                                                                                <?php   
...
<script type="text/javascript">
    ...
    function getlicensefile(event) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(URL::to('dashboard/s/getlicencefile')); ?>",
            data: form_data,
            contentType: false,
