                                  ...
                                  <form action="<?php echo e(URL::to('dashboard/s/edit')); ?>" method="post" enctype="multipart/form-data">
                                          <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="name" id="inputEmail3" value="<?php echo e($company[0]->name); ?>"  required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for="inputdomain3" class="col-sm-2 col-form-label">Company Domain Name</label>
                                                            <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="domain" id="inputdomain3" value="<?php echo e($company[0]->domain); ?>"  required>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                              <input type="text" class="form-control" name="address" id="inputPassword3" value="<?php echo e($company[0]->address); ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                                <label for="inputPassword3" class="col-sm-2 col-form-label">Phone</label>
                                                                <div class="col-sm-10">
                                                                        <input type="text" class="form-control" name="phone" id="inputPassword3" value="<?php echo e($company[0]->phone); ?>" >
                                                                </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Finance contact</label>
                                                            <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="fContact" id="inputEmail3"  value="<?php echo e($company[0]->finance_contact); ?>" required>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                              <input type="text" class="form-control" name="techContact" id="inputPassword3"  value="<?php echo e($company[0]->technical_contact); ?>" required>
                                                                <span>coma seprated</span>                                                              
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                        <input type="text" class="form-control" name="swContact" id="inputPassword3"  value="<?php echo e($company[0]->license_sw_contact); ?>" required>
                                                                <span>coma seprated</span>                                                              
                                                                </div>
                                                        </div>                
                                                        <div class="form-group row">
                                                              ...
                                                              <div class="col-sm-10">
                                                                ...
                                                                if($company[0]->logo != ''){
                                                                ?>
                                                                    <img src="<?php echo e(asset('public/logo_files')); ?>/<?php echo e($company[0]->logo); ?>" style="width:auto;height:70px;"/>
                                                                <?php
                                                                ...
                                                                ?>
                                                                  <img src="<?php echo e(asset('images/no-image-found.png')); ?>" style="width:auto;height:35px;"/>
                                                                <?php
