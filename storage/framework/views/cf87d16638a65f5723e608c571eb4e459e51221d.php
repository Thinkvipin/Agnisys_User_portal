              ...
              <div class=" cta-group d-lg-flex align-items-center justify-content-">
                    ...
                    <?php if(Auth::user()): ?>
                         ...
                         <ul class="fly-right-sub">
                            <li>
                               <a href="<?php echo e(url('/')); ?>/dashboard"><i class="fas fa-fw fa-tachometer-alt"></i>  Dashboard</a>
                            </li>
                            <li>
...
<!-- <header> 
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="account-tab dropdown mobile visible-xs">
                             <?php if(!Auth::user()): ?>
                             <a href="<?php echo e(url('/')); ?>"><i class="fa fa-user"></i> Login</a>
                             <?php endif; ?>
                             <?php if(Auth::user()): ?>
                             <i class="fa fa-user"></i> <?php echo e(Session::get('username')); ?>                                   
                             <ul class="fly-right-sub">
                                <li>
                                   <a href="<?php echo e(url('/')); ?>/dashboard"><i class="fas fa-fw fa-tachometer-alt"></i>  Dashboard</a>
                                </li>
        ...
        <input type="hidden" id="fogbugz_token" value="<?php echo e(Session::get('key')); ?>">
