...
// 		}).on("change",function(){});
    ...
    <div class="chat_window" id="chatWindow">
        ...
        <div class="bottom_wrapper clearfix">
            <input type="hidden" name="userEmail" class="user_email" value="{{Session::get('chatuseremail')}}">
            <input type="hidden" name="userName" class="user_name" value="{{Session::get('chatusername')}}">
