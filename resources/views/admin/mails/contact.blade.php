                ...
                <div class="table100">
					...
					<table>
						<tbody>
                                ...
                                <tr>
                                    <td class="column1 head">Name</td>
                                    <td class="column2">'.$data->name.'</td>
                                    
                                </tr>
                                <tr>
                                    <td class="column1 head">Mobile</td>
                                    <td class="column2">'.$data->mobile.'</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="column1 head">Message</td>
                                    <td class="column2">'.$data->message.'</td>
                                </tr>
                        </tbody>
                </table>
                </body>
