			...
			<div class="wrap-table100">
                <div class="table100">
					...
					<table>
						<tbody>
                                <tr>
                                    <td class="column1 head">Topic</td>
                                    <td class="column2">'.$data->topic.'</td>
                                    
                                </tr>
                                <tr>
                                    <td class="column1 head">Username</td>
                                    <td class="column2">'.$data->username.'</td>
                                    
                                </tr>
                                <tr>
                                    <td class="column1 head">Email</td>
                                    <td class="column2">'.$data->userMail.'</td>
                                </tr>
                                <tr>
                                    <td class="column1 head">Company</td>
                                    <td class="column2">'.$data->company.'</td>
                                </tr>

                                <tr>
                                    <td class="column1 head">Comment </td>
                                    <td class="column2">'.$data->commentText.'</td>
                                    
                                </tr>

                                <tr>
                                    <td class="column1 head">File </td>
                                    <td class="column2"><a href="'.$data->file.'" download> Download Files </a></td> 
                                </tr>
