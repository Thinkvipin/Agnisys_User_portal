        ...
        if (!$this->debug) {
            return <<<EOF
                <div class="container">
                    <h1>$title</h1>
                    <a href="/">
                        <button class="bg-transparent text-grey-darkest font-bold uppercase tracking-wide py-3 px-6 border-2 border-grey-light hover:border-grey rounded-lg" style="cursor:pointer;">
                            Go Home
                        </button>
                    </a>
                </div>
